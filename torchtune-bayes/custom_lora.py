...
def recipe_main(cfg: DictConfig) -> None:
    ...
    if not VANILLA:
        filename = f'{MODEL}-{DATASET}{LIMITED_DATA}-bayesian-uniweight{weight}-defaultprior-lr1e-5-5e-5-1e-5-reinit-stepeval{metaeval_steps}_{RUN_PRUNING}' # no '.log'
    else:
        filename = f'{MODEL}-{DATASET}{LIMITED_DATA}-vanilla-lr1e-5-1e-5-stepeval{metaeval_steps}_{RUN_PRUNING}'
